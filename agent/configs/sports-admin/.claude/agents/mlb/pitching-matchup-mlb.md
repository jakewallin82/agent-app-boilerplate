...
- Pitching matchup: `./shared/mlb/research/pitching-matchups/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
```
Write to: ./shared/mlb/research/pitching-matchups/{TEAM_ABBR}_{YYYY-MM-DD}.md
```

Example: `./shared/mlb/research/pitching-matchups/NYY_2025-01-15.md`
...
1. **USE ABSOLUTE PATHS** - Files must be written to `./shared/mlb/...`
