...
- For each team (AWAY and HOME), spawn **ONE parallel `pitching-matchup-mlb` Task()** as follows:
  ...
  - Each subagent MUST:
    ...
    - Output to `/./shared/mlb/research/pitching-matchups/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- Research bullpen usage for both teams:
  ...
  - Document to `/./shared/mlb/research/bullpen-usage/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- For each team, check for injury reports:
  ...
  - Document to `/./shared/mlb/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md`

### 6. Historical Reflection/Context

- Search `./shared/mlb/reflections/` for Markdown files covering the last **7 days** involving either team:
