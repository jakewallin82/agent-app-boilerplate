...
- Depth charts: `./shared/nfl/research/depth-charts/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md`
- Injury reports: `./shared/nfl/research/injury-reports/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md`
...
```
Write to: ./shared/nfl/research/depth-charts/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md
```

Example: `./shared/nfl/research/depth-charts/CLE_11_29_2025.md`
...
```
Write to: ./shared/injury-reports/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md
```

Example: `./shared/injury-reports/CLE_11_29_2025.md`
...
1. **USE ABSOLUTE PATHS** - Files must be written to `./shared/nfl/...`
