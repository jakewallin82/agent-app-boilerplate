...
- Look for prediction file at: `./shared/nfl/predictions/week_{N}/{AWAY}_vs_{HOME}_week{N}.md`
...
Write to: `./shared/nfl/player-props/week_{N}/{AWAY}_vs_{HOME}_props_week{N}.md`
