...
- Goalie tracker: `./shared/nhl/research/goalie-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
```
Write to: ./shared/nhl/research/goalie-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md
```

Example: `./shared/nhl/research/goalie-tracker/BOS_2025-01-15.md`
...
1. **USE ABSOLUTE PATHS** - Files must be written to `./shared/nhl/...`
