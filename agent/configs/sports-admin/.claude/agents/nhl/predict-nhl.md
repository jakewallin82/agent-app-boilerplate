...
- For each team (AWAY and HOME), spawn **ONE parallel `goalie-researcher-nhl` Task()** as follows:
  ...
  - Each subagent MUST:
    ...
    - Output to `/./shared/nhl/research/goalie-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- Research advanced metrics for both teams:
  ...
  - Document to `/./shared/nhl/research/advanced-stats/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- For each team, check for injury reports:
  ...
  - Document to `/./shared/nhl/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md`

### 5. Historical Reflection/Context

- Search `./shared/nhl/reflections/` for Markdown files covering the last **7 days** involving either team:
