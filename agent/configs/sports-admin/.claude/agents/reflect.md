...
2. **MANDATORY: Gather Full and Accurate Game Data _Before_ Any Analysis**
   ...
   ```bash
   python ./.claude/skills/fetch-play-by-play/scripts/tank01_api.py --game_id {game_id}
   ```

   - Wait for this command to complete. It will create `./shared/nfl/live-games/{game_id}/final.md`.
