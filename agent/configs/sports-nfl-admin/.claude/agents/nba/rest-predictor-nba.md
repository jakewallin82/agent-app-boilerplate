...
```
/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/
```

- Rest tracker: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/rest-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
```
Write to: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/rest-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md
```

Example: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/rest-tracker/LAL_2025-01-15.md`
...
1. **USE ABSOLUTE PATHS** - Files must be written to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/...`
