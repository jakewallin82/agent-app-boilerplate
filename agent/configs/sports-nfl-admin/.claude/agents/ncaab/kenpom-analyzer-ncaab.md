...
```
/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/
```

- Efficiency analysis: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/kenpom-analysis/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
...
```
Write to: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/kenpom-analysis/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md
```

Example: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/kenpom-analysis/DUKE_vs_UNC_2025-01-15.md`
...
1. **USE ABSOLUTE PATHS** - Files must be written to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/...`
