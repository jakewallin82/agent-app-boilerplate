...
- Files in the `data/` directory that were created from web sources
...
3. Search for past reflections involving either team (check `data/nfl/reflections/` for last 3 weeks)
4. Web search for analyst predictions and game previews
5. Write prediction to `data/nfl/predictions/week_{N}/{AWAY}_vs_{HOME}_week{N}.md`
...
3. After all complete, read each prediction file from `data/nfl/predictions/week_{N}/`
...
5. Write summary to `data/nfl/predictions/week_{N}/SUMMARY.md`
...
3. Search for past reflections involving either team (check `data/nba/reflections/` for last 7 days)
4. Web search for analyst predictions and game previews
5. Write prediction to `data/nba/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
...
3. After all complete, read each prediction file from `data/nba/predictions/{YYYY-MM-DD}/`
4. Generate a summary based on what the user wants:
   - Default: List all picks with confidence
   - "Top 5": Highest confidence picks
   - "Best bets": Confidence >= 7
5. Write summary to `data/nba/predictions/{YYYY-MM-DD}/SUMMARY.md`
...
3. Search for past reflections involving either team (check `data/nhl/reflections/` for last 7 days)
4. Research advanced metrics (Corsi, Fenwick, xGF) for both teams
5. Web search for analyst predictions and game previews
6. Write prediction to `data/nhl/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`

**All games on a date** (e.g., "Predict all games on 2025-01-15"):

1. Use the `fetch-odds` skill to get all games for the date
2. Spawn **parallel** `nhl/predict-nhl` subagents for each game
3. After all complete, read each prediction file from `data/nhl/predictions/{YYYY-MM-DD}/`
4. Generate a summary based on what the user wants
5. Write summary to `data/nhl/predictions/{YYYY-MM-DD}/SUMMARY.md`
...
5. Search for past reflections involving either team (check `data/mlb/reflections/` for last 7 days)
6. Web search for analyst predictions and game previews
7. Write prediction to `data/mlb/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`

**All games on a date** (e.g., "Predict all games on 2025-01-15"):

1. Use the `fetch-odds` skill to get all games for the date
2. Spawn **parallel** `mlb/predict-mlb` subagents for each game
3. After all complete, read each prediction file from `data/mlb/predictions/{YYYY-MM-DD}/`
4. Generate a summary based on what the user wants
5. Write summary to `data/mlb/predictions/{YYYY-MM-DD}/SUMMARY.md`
...
3. Search for past reflections involving either team (check `data/ncaab/reflections/` for last 7 days)
4. Research conference context and matchup history
5. Web search for analyst predictions and game previews
6. Write prediction to `data/ncaab/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`

**All games on a date** (e.g., "Predict all games on 2025-01-15"):

1. Use the `fetch-odds` skill to get all games for the date
2. Spawn **parallel** `ncaab/predict-ncaab` subagents for each game
3. After all complete, read each prediction file from `data/ncaab/predictions/{YYYY-MM-DD}/`
4. Generate a summary based on what the user wants
5. Write summary to `data/ncaab/predictions/{YYYY-MM-DD}/SUMMARY.md`
...
Here is an example prediction file path: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/predictions/week_13/ARI_vs_TB_week13.md
...
5. Write summary to `data/nfl/reflections/week_{N}/SUMMARY.md` (if reflecting on a week)
...
Here is an example prediction file path: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/predictions/2025-01-15/LAL_vs_GSW_2025-01-15.md
...
4. After all complete, read each reflection file, calculate overall accuracy, find patterns and key learnings
5. Write summary to `data/nba/reflections/{YYYY-MM-DD}/SUMMARY.md` (if reflecting on a date)
...
4. Write summary to `data/nhl/reflections/{YYYY-MM-DD}/SUMMARY.md` (if reflecting on a date)
...
3. After all complete, read each reflection file, calculate overall accuracy, find patterns and key learnings
4. Write summary to `data/mlb/reflections/{YYYY-MM-DD}/SUMMARY.md` (if reflecting on a date)
...
3. After all complete, read each reflection file, calculate overall accuracy, find patterns and key learnings
4. Write summary to `data/ncaab/reflections/{YYYY-MM-DD}/SUMMARY.md` (if reflecting on a date)

### NFL Live Game Tracking

When the user asks to track a live game (e.g., "Track the Bills game live"):

1. Create directory `data/nfl/live-games/{game_id}/`
2. Enter a loop:
...
- Agent will first fetch and save the ESPN depth chart to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/research/depth-charts/`
- Then research injuries only for STARTERS on that depth chart (max 5 web searches)
- Outputs to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/research/injury-reports/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md`
...
```
Base path: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/
Team: {TEAM_ABBR}
```
...
- Outputs to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/rest-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
```
Base path: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/
Team: {TEAM_ABBR}
...
- Outputs to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/research/goalie-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- Outputs to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/research/pitching-matchups/{TEAM_ABBR}_{YYYY-MM-DD}.md`
...
- Outputs to `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/kenpom-analysis/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
...
```
Base path: /Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/
Away team: {AWAY}
Home team: {HOME}
Game date: {YYYY-MM-DD}
```
...
**Base directory**: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/`

All outputs are **Markdown files** (no JSON). Always use **absolute paths** when writing files:

- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/predictions/week_{N}/{AWAY}_vs_{HOME}_week{N}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/reflections/week_{N}/{AWAY}_vs_{HOME}_week{N}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/live-games/{game_id}/{quarter}_{time}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/research/depth-charts/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md` (e.g., `SF_11_29_2025.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/research/injury-reports/{TEAM_ABBR}_{MM}_{DD}_{YYYY}.md` (e.g., `SF_11_29_2025.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nfl/player-props/week_{N}/{AWAY}_vs_{HOME}_props_week{N}.md`

Use Glob and Grep to find relevant files:

- Find team's recent games: `grep -l "BUF" data/nfl/predictions/week_*/`
- Find all week 13 predictions: `glob data/nfl/predictions/week_13/*.md`

### NBA File Organization

**Base directory**: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/`

**IMPORTANT: NBA uses date-based organization (YYYY-MM-DD), NOT week numbers!**

All outputs are **Markdown files** (no JSON). Always use **absolute paths** when writing files:

- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/reflections/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/rest-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `LAL_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `LAL_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nba/player-props/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_props_{YYYY-MM-DD}.md`

Use Glob and Grep to find relevant files:

- Find team's recent games: `grep -l "LAL" data/nba/predictions/*/`
- Find all games on a date: `glob data/nba/predictions/2025-01-15/*.md`

### NHL File Organization

**Base directory**: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/`
...
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/reflections/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/research/goalie-tracker/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `BOS_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `BOS_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/nhl/player-props/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_props_{YYYY-MM-DD}.md`

Use Glob and Grep to find relevant files:

- Find team's recent games: `grep -l "BOS" data/nhl/predictions/*/`
- Find all games on a date: `glob data/nhl/predictions/2025-01-15/*.md`

### MLB File Organization

**Base directory**: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/`
...
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/reflections/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/research/pitching-matchups/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `NYY_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `NYY_2025-01-15.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/mlb/player-props/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_props_{YYYY-MM-DD}.md`

Use Glob and Grep to find relevant files:

- Find team's recent games: `grep -l "NYY" data/mlb/predictions/*/`
- Find all games on a date: `glob data/mlb/predictions/2025-01-15/*.md`

### NCAAB File Organization

**Base directory**: `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/`

**IMPORTANT: NCAAB uses date-based organization (YYYY-MM-DD), NOT week numbers!**

All outputs are **Markdown files** (no JSON). Always use **absolute paths** when writing files:

- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/predictions/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/reflections/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md`
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/kenpom-analysis/{AWAY}_vs_{HOME}_{YYYY-MM-DD}.md` (e.g., `UCLA_vs_WASH_2025-12-03.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/research/injury-reports/{TEAM_ABBR}_{YYYY-MM-DD}.md` (e.g., `UCLA_2025-12-03.md`)
- `/Users/jakewallin/claude-sports/claude-sports-app/agent/data/ncaab/player-props/{YYYY-MM-DD}/{AWAY}_vs_{HOME}_props_{YYYY-MM-DD}.md`

Use Glob and Grep to find relevant files:

- Find team's recent games: `grep -l "UCLA" data/ncaab/predictions/*/`
- Find all games on a date: `glob data/ncaab/predictions/2025-12-03/*.md`
